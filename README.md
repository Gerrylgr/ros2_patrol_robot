...
- fishbot_application 机器人导航应用相关的 Python 代码（包含初始化，固定点导航和路点导航的实现）
- c_fishbot_application 机器人导航应用 C++ 代码
- autopatrol_interfaces  语音播报的自定义接口
...
- [Liu Gengrui](https://github.com/Gerrylgr)