...
def generate_launch_description():
    ...
    #启动一个 robot_state_publisher 节点，将机器人的状态信息发布到 ROS 2 网络上，使得其他节点可以获取机器人的关节状态和姿态数据
    ...
    # 通过 IncludeLaunchDescription 包含另外 gazebo.launch.py, 用于启动 Gazebo
    ...
    spawn_entity_node = launch_ros.actions.Node(
        ...
        #'-topic' 指定要从 /robot_description 话题中获取模型数据（通常是 URDF 文件发布到该话题）
